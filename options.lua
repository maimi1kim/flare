		...
		community = {
			...
			args = {
				alwaysReaddChannels = {
					...
					desc = "This will automatically delete communities channesl from general and re-add them upon login.",
					width = "full",
		...
		battleground = {
			...
			args = {
				...
				communityDisplayNames = {
					type = "toggle",
					order = 4,
					name = "Displays community member names when gate opens.",
					desc = "This will automatically display all community members found in the Battleground when the gate opens.",
					width = "full",
				...
				blockGameMenuHotKeys = {
					type = "toggle",
					order = 6,
					name = "Block Game Menu hotkeys inside a Battleground?",
					desc = "This will block the Game Menus from coming up inside a Battleground from pressing their hot keys. (To block during recording videos for example.)",
					width = "full",
